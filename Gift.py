...
banner = '\n\033[31;1m╔══╗────╔╗\n║══╬═╦══╬╣ n\033[37;1m ╠══║╬║║║║║n\033[31;1m╚══╩═╩╩╩╩╝      \n          |__| |__| |    |_/  |___ |__/\n\033[37;1m          |  | |  | |___ | \_ |___ |  \\\n\033[36;1mCreated By\033[31;1m :\033[32;1m SOMI BRAND \033[32;1m[\033[37;1mWHATAAP )03455453538\033[32;1m]\n\033[35;1m------------------------------------------'
...
def ceknet():
    try:
    	os.system('reset')
        print internet
        print '\r\033[37;1m[\x1b[92m+\033[37;1m] \033[37;1mReconnect Internet'
        time.sleep(2)
        toolbar_width = 25
        ...
        try:
            ...
            time.sleep(3.5)
            print '\033[37;1m]\033[35;1m ~>\033[31;1m SOMI BRAND i'
            time.sleep(1.5)
            sys.exit()

    except KeyboardInterrupt:
    	time.sleep(3.5)
        exit('\n\033[37;1m[\x1b[92mx\033[37;1m] \033[31;1mProgram \n')
        ...
        try:
            ...
            for pw in sandi:
                try:
                    ...
                    print '\033[37;1m[\033[32;1mx\033[37;1m] \033[31;1mconnction error'
                    sys.exit()
